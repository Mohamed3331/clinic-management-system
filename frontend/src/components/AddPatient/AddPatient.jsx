    ...
    <>
      ...
      >
        <form className={`form-styling`} onSubmit={handleSubmit(submit)}>
          ...
          <input
            className={`${
              formState.errors.patientName && "form-control--invalid"
            }`}
            placeholder={`${
              formState.errors.patientName ? "برجاء ادخال الاسم ثلاثى" : ""
            }`}
            type="text"
          ...
          <input
            className={`${
              formState.errors.phoneNumber && "form-control--invalid"
            }`}
            placeholder={`${
              formState.errors.phoneNumber ? "برجاء ادخال رقم الهاتف" : ""
            }`}
            type="text"
          ...
          <input
            className={`${
              formState.errors.birthDate && "form-control--invalid"
            }`}
            placeholder={`${
              formState.errors.birthDate ? "برجاء ادخال تاريخ الميلاد" : ""
            }`}
            type="date"
